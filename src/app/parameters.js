...
const SPECS = [
  ...
  },
  {
    ...
    unit: 'dB',
    label: 'Input drive',
    hint: 'Level into the whole chain — more drive, more limiting. Negative trims hot sources.',
    group: 'loudness',
  ...
  },
  {
    ...
    unit: '%',
    label: 'Depth',
    hint: 'Early reflections for front/back depth. Not a reverb — no tail. Character select controls the tap colouration.',
    group: 'spatial',
    displayFormatter: rawPct,
    previewSupported: true,
    exportSupported: true,
  ...
  },
  {
    ...
    values: ['classic', 'clean'],
    unit: '',
    label: 'Depth character',
    hint: 'Classic = coloured two-tap reflections. Clean = diffused, band-shaped taps with no audible combing — the mastering-safe choice.',
    group: 'spatial',
    displayFormatter: (v) => String(v),
    previewSupported: true,
    exportSupported: true,
